...
def generate_im(char_ims, num_bg_images):
    ...
    M, out_of_bounds = make_affine_transform(
                            ...
                            to_shape=bg.shape,
                            min_scale=0.65, #original 0.6
                            max_scale=1.1, #original 1.1
                            rotation_variation=1.0, #original 1.0
                            scale_variation=1.5, #original 1.5
                            translation_variation=1.2) #original 1.2
